      ...
      <div className="flex items-center justify-between px-6 py-3.5 bg-gray-900 rounded-full">
        ...
        <div className="w-auto">
          <div className="flex flex-wrap items-center">
            <div className="w-auto">
              <a href="#">
                <img src="./Assets/icon.ico" alt="Zanrly Logo" />
              </a>
            </div>
          </div>
        </div>
              ...
              >
                ...
                {isDropdownOpen && (
                  <ul
                    ...
                    ref={dropdownRef}
                    onMouseEnter={handleMouseEnter} // Added this line
                    onMouseLeave={handleMouseLeave}
                  >
                    <li>
        ...
        <div className="w-auto hidden lg:block">
          <div className="flex items-center space-x-2">
            <a
              className="px-4 py-2.5 text-sm font-bold text-white bg-gray-900 hover:hover:bg-orange-700 rounded-full"
